  ...
  const salvarProduto = async (e) => {
    ...
    try {
      const resposta = await axios.post(
        "https://sistema-precificacao-chi.vercel.app/produtos",
        pacoteDeDados,
      );
      ...
      alert(
        "Erro ao conectar com a API. Verifique se o back-end está rodando!",
      );
    }
  };
  ...
  return (
    <main className="min-h-screen bg-[#0d1117] flex flex-col items-center p-6 font-sans">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="quantidade" className="text-gray-400 text-sm">
            Quantidade da caixa:
          </label>
          <input
            type="number"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="custo" className="text-gray-400 text-sm">
            Custo total da caixa (R$):
          </label>
          <input
            type="number"
            id="custo"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="margem" className="text-gray-400 text-sm">
            Margem de lucro (%):
          </label>
          <input
            type="number"
        ...
        <div className="flex gap-3 mt-2">
          <button
            type="submit"
            className="flex-1 bg-green-700 hover:bg-green-600 text-white font-bold rounded-xl p-3 active:scale-95 transition-transform"
          >
            Adicionar Produto
          </button>
          <button
            ...
            className="flex-1 bg-transparent border border-gray-800 text-gray-400 font-semibold rounded-xl p-3 active:scale-95 transition-transform hover:bg-[#1a1d24]"
          >
            Limpar
          </button>
        </div>
